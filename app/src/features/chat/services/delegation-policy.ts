...
// "obrigad"/"obg" eram stems seguidos de \b — mas \b exige transição
// palavra/não-palavra, e "obrigado"/"obrigada" continuam com uma letra
// (word char) logo depois do stem, então o \b nunca casava e essas
// saudações de agradecimento caíam no ramo de verbo de ação (ex.: "ajuda"
// em "obrigado pela ajuda"). Usar as formas completas resolve o falso
// negativo sem abrir mão do \b nas demais palavras da lista.
