  ...
  return (
    ...
    >
      ...
      <div
        ...
        tabIndex={-1}
        className="felixo-anim-sequential-panel min-h-0 w-full flex-1 overflow-y-auto overscroll-contain rounded-lg bg-zinc-800 p-4 shadow-2xl ring-1 ring-white/10 focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-sky-400"
      >
        ...
        <p className="mb-3 rounded-sm border border-[color-mix(in_srgb,var(--color-warning)_38%,transparent)] bg-[color-mix(in_srgb,var(--color-warning)_16%,transparent)] px-2.5 py-2 text-[11px] leading-relaxed text-(--color-warning)">
        ...
        {erro && <p className="mb-3 text-xs text-theme-error">{erro}</p>}
        ...
        <div className="flex justify-end gap-2">
          <button
            ...
            onClick={onClose}
            disabled={busy}
            className="felixo-btn rounded-sm px-3 py-1.5 text-sm text-zinc-300 hover:bg-white/5 disabled:opacity-50"
          >
            Cancelar
          </button>
          <button
