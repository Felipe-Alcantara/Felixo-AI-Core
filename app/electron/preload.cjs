...
contextBridge.exposeInMainWorld('felixo', {
  ...
  git: {
    ...
    listFiles: (params) => ipcRenderer.invoke('git:list-files', params),
    listBranches: (params) => ipcRenderer.invoke('git:list-branches', params),
    switchBranch: (params) => ipcRenderer.invoke('git:switch-branch', params),
    getLog: (params) => ipcRenderer.invoke('git:get-log', params),
    push: (params) => ipcRenderer.invoke('git:push', params),
    pull: (params) => ipcRenderer.invoke('git:pull', params),
    discardFile: (params) => ipcRenderer.invoke('git:discard-file', params),
    readFile: (params) => ipcRenderer.invoke('git:read-file', params),
