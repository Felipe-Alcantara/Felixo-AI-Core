...
O botão **Notificações** mostra agentes que terminaram um trabalho, encerraram a sessão ou estão aguardando aprovação/resposta. Clique em uma notificação para centralizar e abrir o respectivo terminal.
